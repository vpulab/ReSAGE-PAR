...
class RAPv2DatasetAll(torch.utils.data.Dataset):
    ...
    listAttributePrompt=['bald head', 'long hair', 'black hair', 'hat', 'glasses', 'shirt','sweater','vest','t-shirt','cotton','jacket','suit','tight','short sleeve','others', 'long trousers','skirt','short skirt','dress','jeans','tight trousers', 'leather shoes', 'sports shoes', 'boots', 'cloth shoes', 'casual shoes', 'other shoes', 'backpack','shoulder bag','hand bag','box','plastic bag','paper bag','hand trunk','other', 'ages less 16', 'age between 17 and 30', 'age between 31 and 45', 'age between 45 and 60', 'woman', 'fat body','normal body','thin body','customer','employee', 'calling','talking','gathering','holding','pushing','pulling','carrying by arm','carrying by hand','other']
    ...
    complementary_attributes = {
            ...
            'ages less 16': ['age between 17 and 30', 'age between 31 and 45', 'age between 45 and 60'],
            'age between 17 and 30': ['ages less 16', 'age between 31 and 45', 'age between 45 and 60'],
            'age between 31 and 45': ['ages less 16', 'age between 17 and 30', 'age between 45 and 60'],
            'age between 45 and 60': ['ages less 16', 'age between 17 and 30','age between 31 and 45'],
            'woman': ['man'],
            'man': ['woman'],
    ...
    def __init__(self, split, path_dataset=None, path_gt=None, path_gt_img=None):
        ...
        super(RAPv2DatasetAll, self)
        
        # Use provided paths or defaults
        if path_dataset is None:
            if split=="train":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv2/train/"
            elif split=="val":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv2/val/"
            elif split=="test":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv2/test/"
        
        self.pathDataset = path_dataset
        
        if path_gt is None:
            path_gt = "/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/RAP2/dataset_all.pkl"
