...
class RAPv1DatasetAll(torch.utils.data.Dataset):
    ...
    #updated
    listHsAtDS=['hs-BaldHead', 'hs-LongHair', 'hs-BlackHair', 'hs-Hat', 'hs-Glasses', 'hs-Muffler']
    listHsPrompt=['bald head', 'long hair', 'black hair', 'hat', 'glasses', 'muffler']

    #updated
    listActionsAtDS=['action-Calling', 'action-Talking', 'action-Gathering', 'action-Holding', 'action-Pusing', 'action-Pulling', 'action-CarrybyArm', 'action-CarrybyHand']
    listActionPrompt=['calling','talking','gathering','holding','pushing','pulling','carrying by arm','carrying by hand']

    #updated
    listAttAtDS=['attach-Backpack', 'attach-SingleShoulderBag', 'attach-HandBag', 'attach-Box', 'attach-PlasticBag', 'attach-PaperBag', 'attach-HandTrunk', 'attach-Other']
    listAttPrompt=['backpack','sinlge shoulder bag','hand bag','box','plastic bag','paper bag','hand trunk','other']

    #updated
    listUbAtDS=['ub-Shirt', 'ub-Sweater', 'ub-Vest', 'ub-TShirt', 'ub-Cotton', 'ub-Jacket', 'ub-SuitUp', 'ub-Tight', 'ub-ShortSleeve']
    listUbPrompt = ['shirt','sweater','vest','t-shirt','cotton','jacket','suit','tight','short sleeve']
    ...
    #updated
    listShoeAtDS=['shoes-Leather', 'shoes-Sport', 'shoes-Boots', 'shoes-Cloth', 'shoes-Casual']
    listShoePrompt=['leather shoes', 'sports shoes', 'boots', 'cloth shoes', 'casual shoes']
    ...
    listAttributesRAPv1 = ['Female', 'AgeLess16', 'Age17-30', 'Age31-45', 'BodyFat', 'BodyNormal', 'BodyThin', 'Customer', 'Clerk', 'hs-BaldHead', 'hs-LongHair', 'hs-BlackHair', 'hs-Hat', 'hs-Glasses', 'hs-Muffler', 'ub-Shirt', 'ub-Sweater', 'ub-Vest', 'ub-TShirt', 'ub-Cotton', 'ub-Jacket', 'ub-SuitUp', 'ub-Tight', 'ub-ShortSleeve', 'lb-LongTrousers', 'lb-Skirt', 'lb-ShortSkirt', 'lb-Dress', 'lb-Jeans', 'lb-TightTrousers', 'shoes-Leather', 'shoes-Sport', 'shoes-Boots', 'shoes-Cloth', 'shoes-Casual', 'attach-Backpack', 'attach-SingleShoulderBag', 'attach-HandBag', 'attach-Box', 'attach-PlasticBag', 'attach-PaperBag', 'attach-HandTrunk', 'attach-Other', 'action-Calling', 'action-Talking', 'action-Gathering', 'action-Holding', 'action-Pusing', 'action-Pulling', 'action-CarrybyArm', 'action-CarrybyHand']
    # from preprocess rethinking
    listAttributePrompt=['woman', 'age less than 16', 'age between 17 and 30', 'age between 31 and 45', 'fat body', 'normal body', 'thin body', 'customer', 'clerk', 'bald head', 'long hair', 'black hair', 'hat', 'glasses', 'muffler', 'shirt', 'sweater', 'vest', 't-shirt', 'cotton', 'jacket', 'suitup', 'tight', 'short sleeve', 'long trousers', 'skirt', 'short skirt', 'dress', 'jeans', 'tight trousers', 'leather shoes', 'sport shoes', 'boots shoes', 'cloth shoes', 'casual shoes', 'backpack', 'sinlge shoulder bag', 'hand bag','box','plastic bag','paper bag','hand trunk','other', 'calling','talking','gathering','holding','pushing','pulling','carrying by arm','carrying by hand']
    complementary_attributes = {
        ...
        # Age groups
        'age less than 16': ['age between 17 and 30', 'age between 31 and 45'],
        'age between 17 and 30': ['age less than 16', 'age between 31 and 45'],
        'age between 31 and 45': ['age less than 16', 'age between 17 and 30'],
        
        # Body
        'fat body': ['normal body', 'thin body'],
        'normal body': ['fat body', 'thin body'],
        'thin body': ['normal body', 'fat body'],
        
        # Roles
        'customer': ['clerk', 'carrying by hand'],
        'clerk': ['customer', 'suitup'],
        
        # Hair
        'bald head': ['hat', 'glasses'],
        'long hair': ['black hair', 'woman'],
        'black hair': ['long hair', 'woman'],
        ...
        # Upper clothing
        'shirt': ['vest', 'suitup'],
        'sweater': ['cotton', 'jacket'],
        'vest': ['shirt', 't-shirt'],
        't-shirt': ['short sleeve', 'jeans'],
        'cotton': ['sweater', 'jacket'],
        'jacket': ['sweater', 'cotton'],
        'suitup': ['shirt', 'leather shoes'],
        'tight': ['tight trousers', 'short skirt'],
        
        # Clothing style details
        'short sleeve': ['t-shirt', 'vest'],
        'long trousers': ['jeans', 'tight trousers'],
        'skirt': ['short skirt', 'dress'],
        'short skirt': ['skirt', 'dress'],
        'dress': ['skirt', 'woman'],
        'jeans': ['t-shirt', 'sport shoes'],
        'tight trousers': ['tight', 'long trousers'],
        
        # Shoes
        'leather shoes': ['suitup', 'casual shoes'],
        'sport shoes': ['jeans', 'casual shoes'],
        'boots shoes': ['long trousers', 'skirt'],
        'cloth shoes': ['casual shoes', 'jeans'],
        'casual shoes': ['jeans', 'sport shoes'],
        
        # Bags
        'backpack': ['sinlge shoulder bag', 'hand bag'],
        'sinlge shoulder bag': ['backpack', 'hand bag'],
        'hand bag': ['sinlge shoulder bag', 'woman'],
        
        # Objects carried
        'box': ['plastic bag', 'paper bag'],
        'plastic bag': ['paper bag', 'hand trunk'],
        'paper bag': ['plastic bag', 'hand trunk'],
        'hand trunk': ['box', 'plastic bag'],
        'other': ['box', 'plastic bag'],
        
        # Actions
        'calling': ['talking', 'holding'],
        'talking': ['calling', 'gathering'],
        'gathering': ['talking', 'holding'],
        'holding': ['carrying by hand', 'carrying by arm'],
    ...
    listAttributes = listAttributesRAPv1
    all_images = []
    def __init__(self, split, path_dataset=None, path_gt=None, path_gt_img=None):


        #super(RAPzsDataset, self)
        super(RAPv1DatasetAll, self)
        
        # Use provided paths or defaults
        if path_dataset is None:
            if split=="train":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv1/trainval/"
            elif split=="val":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv1/trainval/"
            elif split=="test":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/RAPv1/test/"
        
        self.pathDataset = path_dataset
        
        if path_gt is None:
            path_gt = "/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/RAP/dataset_all.pkl"
        
        if path_gt_img is None:
            path_gt_img = "/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/RAP/RAP_dataset/"
        ...
        self.all_captions = []
        # there is not split of train val
    ...
    def getNAttributesInPrompt(self, prompt):
        
        nAttributes=0
        for attribute in self.listAttributePrompt:
            if attribute == 'woman':
                if 'man' in prompt:
                    nAttributes+=1
                elif 'woman' in prompt:
                    nAttributes+=1
