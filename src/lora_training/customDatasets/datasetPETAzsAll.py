...
class PETAzsDatasetAll(Dataset):
    ...
    listUpperBodyAtDS= ['upperBodyThickStripes','upperBodySweater','upperBodySuit','upperBodyNoSleeve','upperBodyLongSleeve','upperBodyShortSleeve', 'upperBodyCasual','upperBodyFormal','upperBodyJacket','upperBodyLogo', 'upperBodyPlaid',
                    'upperBodyThinStripes',  'upperBodyTshirt', 'upperBodyOther',
                    'upperBodyVNeck']
    listUpperBodyPrompt =['thick stripes', 'sweater','suit', 'no sleeve', 'long sleeve', 'short sleeve', 'casual', 'formal', 'jacket', 'logo', 'plaid', 'thin stripes', 't shirt', 'other', 'vneck']
    ...
    listFootwearAtDS=['footwearLeatherShoes', 'footwearSandals', 'footwearShoes','footwearSneaker','footwearStocking', 'footwearBoots']
    listFootwearAtPrompt=['leather shoes', 'sandals', 'shoes', 'sneakers', 'stocking', 'boots']
    ...
    listAttributesPETAzs = [
                            ...
                            'carryingBackpack', 'carryingOther', 
                            'lowerBodyCasual', 'upperBodyCasual', 'lowerBodyFormal', 'upperBodyFormal', 
                            'accessoryHat', 
                            'upperBodyJacket', 
                            'lowerBodyJeans', 
                            'footwearLeatherShoes', 
                            'upperBodyLogo', 'hairLong', 'personalMale', 
                            'carryingMessengerBag', 'accessoryMuffler', 
                            'accessoryNothing', 'carryingNothing', 
                            'upperBodyPlaid', 'carryingPlasticBags', 
                            'footwearSandals', 'footwearShoes', 'lowerBodyShorts', 
                            'upperBodyShortSleeve', 'lowerBodyShortSkirt', 'footwearSneaker', 
                            'upperBodyThinStripes', 'accessorySunglasses', 'lowerBodyTrousers', 
                            'upperBodyTshirt', 'upperBodyOther', 'upperBodyVNeck', 'upperBodyBlack', 
                            'upperBodyBlue', 'upperBodyBrown', 'upperBodyGreen', 'upperBodyGrey', 
                            'upperBodyOrange', 'upperBodyPink', 'upperBodyPurple', 'upperBodyRed', 
                            'upperBodyWhite', 'upperBodyYellow', 'lowerBodyBlack', 'lowerBodyBlue', 
                            'lowerBodyBrown', 'lowerBodyGreen', 'lowerBodyGrey', 'lowerBodyOrange', 
                            'lowerBodyPink', 'lowerBodyPurple', 'lowerBodyRed', 'lowerBodyWhite', 
                            'lowerBodyYellow', 'hairBlack', 'hairBlue', 'hairBrown', 'hairGreen', 
                            'hairGrey', 'hairOrange', 'hairPink', 'hairPurple', 'hairRed', 'hairWhite', 
                            'hairYellow', 'footwearBlack', 'footwearBlue', 'footwearBrown', 'footwearGreen', 
                            'footwearGrey', 'footwearOrange', 'footwearPink', 'footwearPurple', 'footwearRed',
                            'footwearWhite', 'footwearYellow', 'accessoryHeadphone', 'personalLess15', 
                            'carryingBabyBuggy', 'hairBald', 'footwearBoots', 'lowerBodyCapri', 
                            'carryingShoppingTro', 'carryingUmbrella', 'personalFemale', 'carryingFolder', 
                            'accessoryHairBand', 'lowerBodyHotPants', 'accessoryKerchief', 'lowerBodyLongSkirt', 
                            'upperBodyLongSleeve', 'lowerBodyPlaid', 'lowerBodyThinStripes', 
                            'carryingLuggageCase', 'upperBodyNoSleeve', 'hairShort', 'footwearStocking', 
                            'upperBodySuit', 'carryingSuitcase', 'lowerBodySuits', 'upperBodySweater', 
    ...
    def __init__(self, split, path_dataset=None, path_gt=None, path_gt_img=None):
        ...
        super(PETAzsDatasetAll, self)
        
        # Use provided paths or defaults
        if path_dataset is None:
            if split=="train":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/PETAzs/train/"
            elif split=="val":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/PETAzs/val/"
            elif split=="test":
                path_dataset = "/mnt/rhome/paa/pedestrian/datasetForFID/PETAzs/test/"
        
        self.pathDataset = path_dataset
        
        if path_gt is None:
            path_gt = "/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/PETA/dataset_zs_run0.pkl"
