...
class Blip2Base(BaseModel):
    ...
    def load_from_pretrained(self, url_or_filename):
        import os
        checkpoint = torch.load(os.path.join(google_bert_path, "pytorch_model.bin"), map_location="cpu")
        # 2. Hacemos la carga segura: si existe la llave "model" la usamos, si no, usamos el archivo entero
