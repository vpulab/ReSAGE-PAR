...
if __name__ == "__main__":
    save_dir = '/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/RAP2/'
    new_split_path = f'/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/RAP2/dataset_zs_run0.pkl'
