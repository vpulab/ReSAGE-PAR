...
petazs_insertname=['<ImageHere_Head>', 
                 '<ImageHere_Top>', 
                 '<ImageHere_Under>', 
                 '<ImageHere_Shoes>', 
                 '<ImageHere_Bag>', 
                 '<ImageHere_Face>']
petazs_instuction= '''###Human: Analyse a person's photo and use the options provided to categorise their appearance into attributes, 
<Img><ImageHere_Head></Img> What wearing on head? 
<Img><ImageHere_Top></Img> What wearing on top? 
<Img><ImageHere_Under></Img> What wearing on under? 
<Img><ImageHere_Shoes></Img> What type about shoes? 
<Img><ImageHere_Bag></Img> What type about bag? 
<Img><ImageHere_Face></Img> How old? Is man or woman?. ###Assistant:'''
petazs_group_details = [5,10,6,4,5,5]
...
<Img><ImageHere_Face></Img> Age? Is the person male or female? 
<Img><ImageHere_Full></Img> Body shape? Identity? Activity? ###Assistant:'''
#se quita el idx 38 y este en el grupo ultimo


rapzs_group_details=[5,10,6,6,8,4,14]
...
instruction={
    ...
    "PETAzs":{
        "instruction":petazs_instuction,
        "insert_name":petazs_insertname,
        "group_details":petazs_group_details,
        },
    "PA100k":{
    ...
    "RAPzs":{
        "instruction":rapzs_instuction,
        "insert_name":rap_insertname,
        "group_details":rapzs_group_details,
        },
    "MSP":{
