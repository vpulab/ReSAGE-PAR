...
def argument_parser():
    ...
    parser.add_argument("--pkl_path", type=str, default='./model/peta.pkl')
    ...
    parser.add_argument("--syn_use", action='store_true')
    parser.add_argument("--synthetic_path", type=str, default=None)
    parser.add_argument("--syn_pseudolabels_csv", type=str, default=None)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--syn_use_frac", type=float, default=1.0)
    parser.add_argument("--syn_img_subdir", type=str, default=None)
