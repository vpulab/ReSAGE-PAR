...
@LOSSES.register("weightedbceloss")
class BCELoss(nn.Module):

    def __init__(self, sample_weight=None, size_sum=True, scale=None, tb_writer=None, pos_weight_tensor = None):
    ...
    def forward(self, logits, targets):
        ...
        self.pos_weight_tensor = self.pos_weight_tensor.to(device='cuda')
        loss_m = F.binary_cross_entropy_with_logits(logits, targets, reduction='none', pos_weight=self.pos_weight_tensor)
