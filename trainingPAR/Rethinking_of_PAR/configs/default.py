...
_C.SYNTHETIC = CN()
_C.SYNTHETIC.USE = False
_C.SYNTHETIC.PERCENTAGE = 0.0
_C.SYNTHETIC.PATH = ""
_C.SYNTHETIC.PANDASFILE = None
_C.SYNTHETIC.VECTOR = -1

## MALS dataset
_C.SYNTHETIC.USE_MALS = False
_C.SYNTHETIC.MALS_PATH = ""

_C.SYNTHETIC.PSEUDOLABELS_CSV = None



_C.SYNTHETICTEST = CN()
_C.SYNTHETICTEST.USE = False
_C.SYNTHETICTEST.PERCENTAGE = 0.0
_C.SYNTHETICTEST.PATH = ""
...
_C.DATASET.ROOT = '/mnt/rhome/paa/pedestrian/Rethinking_of_PAR/data/PA100k/'
...
_C.TRAIN.DATAAUG.NUMCLASSES = 100
_C.TRAIN.DATAAUG.ENABLE = False  # Enable MixUp/CutMix (requires rethinking_dataaug environment)
